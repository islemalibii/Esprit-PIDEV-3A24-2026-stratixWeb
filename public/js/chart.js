document.addEventListener("DOMContentLoaded", () => {
  ...
  if (document.getElementById("salesChart")) {
    ...
    const salesThisYear = [
      42000, 53000, 48000, 61000, 72000, 69000, 74000, 82000, 78000, 86000,
      91000, 97000,
    ];
    const salesLastYear = [
    ...
    document.getElementById("btn-update").addEventListener("click", () => {
      if (showingBoth) {
        ...
        document.getElementById("btn-update").textContent =
          "Show This Year Only";
      }
    ...
    function updateMonthlySales(currentYearArray, compareYearArray = null) {
      if (!Array.isArray(currentYearArray) || currentYearArray.length !== 12) {
        console.warn(
          "updateMonthlySales expects an array of 12 numbers for currentYearArray",
        );
        return;
      }
